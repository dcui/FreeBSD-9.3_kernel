/*	$FreeBSD: releng/9.3/sys/contrib/ipfilter/netinet/ip_auth.c 207369 2010-04-29 11:52:42Z bz $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: releng/9.3/sys/contrib/ipfilter/netinet/ip_auth.c 207369 2010-04-29 11:52:42Z bz $";
