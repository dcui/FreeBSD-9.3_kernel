...
# $FreeBSD: releng/9.3/sys/powerpc/ps3/ps3-hv-asm.awk 229114 2011-12-31 15:11:47Z nwhitehorn $

BEGIN {
	printf("/* $FreeBSD: releng/9.3/sys/powerpc/ps3/ps3-hv-asm.awk 229114 2011-12-31 15:11:47Z nwhitehorn $ */\n\n");
