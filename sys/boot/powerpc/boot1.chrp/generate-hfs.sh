...
# $FreeBSD: releng/9.3/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 229461 2012-01-04 03:37:41Z eadler $
...
echo '# $FreeBSD: releng/9.3/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 229461 2012-01-04 03:37:41Z eadler $' >> Makefile.hfs
...
echo '$FreeBSD: releng/9.3/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 229461 2012-01-04 03:37:41Z eadler $' >> $OUTPUT_FILE.bz2.uu
